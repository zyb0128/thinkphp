...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-09-27 06:25:13
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `zyb_action` (
...
INSERT INTO `zyb_action` (`id`, `name`, `title`, `remark`, `rule`, `log`, `type`, `status`, `update_time`) VALUES
...
CREATE TABLE IF NOT EXISTS `zyb_action_log` (
...
CREATE TABLE IF NOT EXISTS `zyb_addons` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `zyb_addons` (`id`, `name`, `title`, `description`, `status`, `config`, `author`, `version`, `create_time`, `has_adminlist`) VALUES
...
CREATE TABLE IF NOT EXISTS `zyb_attachment` (
...
CREATE TABLE IF NOT EXISTS `zyb_attribute` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `zyb_attribute`
--

INSERT INTO `zyb_attribute` (`id`, `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES
...
--
-- 表的结构 `zyb_auth_extend`
--

CREATE TABLE IF NOT EXISTS `zyb_auth_extend` (
...
--
-- 转存表中的数据 `zyb_auth_extend`
--

INSERT INTO `zyb_auth_extend` (`group_id`, `extend_id`, `type`) VALUES
(1, 1, 1),
(1, 1, 2),
(1, 2, 1),
(1, 2, 2),
...
CREATE TABLE IF NOT EXISTS `zyb_auth_group` (
...
--
-- 转存表中的数据 `zyb_auth_group`
--

INSERT INTO `zyb_auth_group` (`id`, `module`, `type`, `title`, `description`, `status`, `rules`) VALUES
...
--
-- 表的结构 `zyb_auth_group_access`
--

CREATE TABLE IF NOT EXISTS `zyb_auth_group_access` (
...
CREATE TABLE IF NOT EXISTS `zyb_auth_rule` (
...
--
-- 转存表中的数据 `zyb_auth_rule`
--

INSERT INTO `zyb_auth_rule` (`id`, `module`, `type`, `name`, `title`, `status`, `condition`) VALUES
...
CREATE TABLE IF NOT EXISTS `zyb_category` (
...
--
-- 转存表中的数据 `zyb_category`
--

INSERT INTO `zyb_category` (`id`, `name`, `title`, `pid`, `sort`, `list_row`, `meta_title`, `keywords`, `description`, `template_index`, `template_lists`, `template_detail`, `template_edit`, `model`, `type`, `link_id`, `allow_publish`, `display`, `reply`, `check`, `reply_model`, `extend`, `create_time`, `update_time`, `status`, `icon`) VALUES
...
CREATE TABLE IF NOT EXISTS `zyb_channel` (
...
INSERT INTO `zyb_channel` (`id`, `pid`, `title`, `url`, `sort`, `create_time`, `update_time`, `status`, `target`) VALUES
...
CREATE TABLE IF NOT EXISTS `zyb_config` (
...
INSERT INTO `zyb_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `status`, `value`, `sort`) VALUES
...
CREATE TABLE IF NOT EXISTS `zyb_document` (
...
--
-- 转存表中的数据 `zyb_document`
--

INSERT INTO `zyb_document` (`id`, `uid`, `name`, `title`, `category_id`, `description`, `root`, `pid`, `model_id`, `type`, `position`, `link_id`, `cover_id`, `display`, `deadline`, `attach`, `view`, `comment`, `extend`, `level`, `create_time`, `update_time`, `status`) VALUES
(1, 1, '', 'OneThink1.0正式版发布', 2, '大家期待的OneThink正式版发布', 0, 0, 2, 2, 0, 0, 0, 1, 0, 0, 8, 0, 0, 0, 1387260660, 1387263112, 1);

-- --------------------------------------------------------

--
-- 表的结构 `zyb_document_article`
--

CREATE TABLE IF NOT EXISTS `zyb_document_article` (
...
--
-- 转存表中的数据 `zyb_document_article`
--

INSERT INTO `zyb_document_article` (`id`, `parse`, `content`, `template`, `bookmark`) VALUES
...
--
-- 表的结构 `zyb_document_download`
--

CREATE TABLE IF NOT EXISTS `zyb_document_download` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文档ID',
  `parse` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '内容解析类型',
...
CREATE TABLE IF NOT EXISTS `zyb_file` (
...
CREATE TABLE IF NOT EXISTS `zyb_hooks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `zyb_hooks` (`id`, `name`, `description`, `type`, `update_time`, `addons`) VALUES
...
CREATE TABLE IF NOT EXISTS `zyb_member` (
...
INSERT INTO `zyb_member` (`uid`, `nickname`, `sex`, `birthday`, `qq`, `score`, `login`, `reg_ip`, `reg_time`, `last_login_ip`, `last_login_time`, `status`) VALUES
(1, 'admin', 0, '0000-00-00', '', 0, 1, 0, 1473400966, 0, 1473400966, 1);
...
CREATE TABLE IF NOT EXISTS `zyb_menu` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '文档ID',
...
INSERT INTO `zyb_menu` (`id`, `title`, `pid`, `sort`, `url`, `hide`, `tip`, `group`, `is_dev`) VALUES
...
CREATE TABLE IF NOT EXISTS `zyb_model` (
...
INSERT INTO `zyb_model` (`id`, `name`, `title`, `extend`, `relation`, `need_pk`, `field_sort`, `field_group`, `attribute_list`, `template_list`, `template_add`, `template_edit`, `list_grid`, `list_row`, `search_key`, `search_list`, `create_time`, `update_time`, `status`, `engine_type`) VALUES
...
CREATE TABLE IF NOT EXISTS `zyb_picture` (
...
--
-- 表的结构 `zyb_ucenter_admin`
--

CREATE TABLE IF NOT EXISTS `zyb_ucenter_admin` (
...
--
-- 表的结构 `zyb_ucenter_app`
--

CREATE TABLE IF NOT EXISTS `zyb_ucenter_app` (
...
--
-- 表的结构 `zyb_ucenter_member`
--

CREATE TABLE IF NOT EXISTS `zyb_ucenter_member` (
...
--
-- 转存表中的数据 `zyb_ucenter_member`
--

INSERT INTO `zyb_ucenter_member` (`id`, `username`, `password`, `email`, `mobile`, `reg_time`, `reg_ip`, `last_login_time`, `last_login_ip`, `update_time`, `status`) VALUES
(1, 'admin', '44fdee4150b7b4d2af21cdfd04e13626', '287744023@qq.com', '', 1473400966, 3746104938, 0, 0, 1473400966, 1);

-- --------------------------------------------------------

--
-- 表的结构 `zyb_ucenter_setting`
--

CREATE TABLE IF NOT EXISTS `zyb_ucenter_setting` (
...
CREATE TABLE IF NOT EXISTS `zyb_url` (
...
CREATE TABLE IF NOT EXISTS `zyb_userdata` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户id',
