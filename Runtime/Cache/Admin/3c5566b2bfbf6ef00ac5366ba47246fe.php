...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/thinkphp/Public/Admin/css/login.css" media="all">
       	<link rel="stylesheet" type="text/css" href="/thinkphp/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
